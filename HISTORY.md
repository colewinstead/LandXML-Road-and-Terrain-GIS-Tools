...
Follow-up QGIS 3.44 work guarded provider unload when QGIS had already deleted it, kept the profile-covered part of a 3D centerline, and aligned station points to whole interval multiples. Extract LandXML Profiles gained loaded-layer labels, VPC/VPI/VPT controls, tangent grades, K values, vertical exaggeration and optional schematic profile layers beside mapped alignments. The updated QGIS 4 runtime check remains outstanding.
